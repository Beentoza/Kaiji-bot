...
from helpers.logger_config import internal_logger as logger, LOG_LEVEL
...
try:
    ...
    logger.debug("Successful engine creation!")
    ...
    logger.info("Successful factory creation!")

except Exception as e:
    logger.error(f"Error when trying to create engine: {e}")
    raise
