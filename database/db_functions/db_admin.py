...
class AdminRepository:
    ...
    async def set_target_balance(self, user_id: int, balance: int) -> int | None:
    ...
    async def add_target_balance(self, user_id: int, amount: int) -> int | None:
    ...
    async def set_target_status(self, user_id: int, status: int) -> bool:
